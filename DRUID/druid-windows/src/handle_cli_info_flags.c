...
{
    long unsigned int help_file_return_value = display_file(ac, av,
        HELP_FLAG, HELP_FLAG_OPTION, HELP_FILE);
    long unsigned int format_file_return_value = display_file(ac, av,
        FORMAT_FLAG, FORMAT_FLAG_OPTION, FORMAT_FILE);
    long unsigned int license_file_return_value = display_file(ac, av,
